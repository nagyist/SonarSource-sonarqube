...
CREATE TABLE "A3S_ANALYSIS_USAGES"(
...
ALTER TABLE "A3S_ANALYSIS_USAGES" ADD CONSTRAINT "PK_A3S_ANALYSIS_USAGES" PRIMARY KEY("UUID");
CREATE INDEX "IDX_A3S_ANALYSIS_USAGES_PROJ" ON "A3S_ANALYSIS_USAGES"("CREATED_AT" NULLS FIRST, "PROJECT_UUID" NULLS FIRST);

CREATE TABLE "A3S_CONTEXT_ITEMS"(
    "CONTEXT_UUID" CHARACTER VARYING(40) NOT NULL,
    "ITEM_ID" CHARACTER VARYING(255) NOT NULL,
    "SHA256" CHARACTER VARYING(64) NOT NULL
);
ALTER TABLE "A3S_CONTEXT_ITEMS" ADD CONSTRAINT "PK_A3S_CONTEXT_ITEMS" PRIMARY KEY("CONTEXT_UUID", "ITEM_ID");
CREATE INDEX "IDX_A3S_CTX_ITEMS_SHA256" ON "A3S_CONTEXT_ITEMS"("SHA256" NULLS FIRST);

CREATE TABLE "A3S_CONTEXTS"(
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "ANALYSIS_UUID" CHARACTER VARYING(40) NOT NULL,
    "BRANCH_UUID" CHARACTER VARYING(40) NOT NULL,
    "BRANCH_NAME" CHARACTER VARYING(255) DEFAULT '' NOT NULL,
    "PROJECT_UUID" CHARACTER VARYING(40) NOT NULL,
    "KIND" CHARACTER VARYING(40) NOT NULL,
    "CREATED_AT" BIGINT NOT NULL,
    "EXPIRES_AT" BIGINT
);
ALTER TABLE "A3S_CONTEXTS" ADD CONSTRAINT "PK_A3S_CONTEXTS" PRIMARY KEY("UUID");
CREATE INDEX "IDX_A3S_CONTEXTS_PROJ_BRANCH" ON "A3S_CONTEXTS"("PROJECT_UUID" NULLS FIRST, "BRANCH_NAME" NULLS FIRST);
CREATE INDEX "IDX_A3S_CONTEXTS_EXPIRES_AT" ON "A3S_CONTEXTS"("EXPIRES_AT" NULLS FIRST);
...
CREATE TABLE "ADMIN_ALERT_STATUS"(
    "UUID" CHARACTER VARYING(40) NOT NULL,
...
ALTER TABLE "ADMIN_ALERT_STATUS" ADD CONSTRAINT "PK_ADMIN_ALERT_STATUS" PRIMARY KEY("UUID");
CREATE INDEX "IDX_ADMIN_ALERT_STATUS_KEY" ON "ADMIN_ALERT_STATUS"("ALERT_KEY" NULLS FIRST);

CREATE TABLE "AGENT_SCHED_PROC_ISSUES"(
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "PROJECT_ID" CHARACTER VARYING(400) NOT NULL,
    "ISSUE_KEY" CHARACTER VARYING(50) NOT NULL,
    "PROCESSED_AT" BIGINT NOT NULL
);
ALTER TABLE "AGENT_SCHED_PROC_ISSUES" ADD CONSTRAINT "PK_AGENT_SCHED_PROC_ISSUES" PRIMARY KEY("UUID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "UQ_AGENT_SCHED_PROC_ISSUES" ON "AGENT_SCHED_PROC_ISSUES"("PROJECT_ID" NULLS FIRST, "ISSUE_KEY" NULLS FIRST);

CREATE TABLE "AGENT_SCHEDULES"(
    "PROJECT_ID" CHARACTER VARYING(400) NOT NULL,
    "ENABLED" BOOLEAN DEFAULT FALSE NOT NULL,
    "NEXT_RUN_AT" BIGINT NOT NULL,
    "FREQUENCY" CHARACTER VARYING(10) DEFAULT 'DAILY' NOT NULL,
    "DAY_OF_WEEK" CHARACTER VARYING(10),
    "RUN_HOUR" INTEGER DEFAULT 2 NOT NULL,
    "TIMEZONE" CHARACTER VARYING(50) DEFAULT 'UTC' NOT NULL,
    "PROJECT_SELECTION_MODE" CHARACTER VARYING(10),
    "MAX_ISSUES_PER_RUN" INTEGER DEFAULT 5 NOT NULL,
    "MAX_OPEN_PRS" INTEGER DEFAULT 3 NOT NULL,
    "CREATED_AT" BIGINT NOT NULL,
    "UPDATED_AT" BIGINT NOT NULL
);
ALTER TABLE "AGENT_SCHEDULES" ADD CONSTRAINT "PK_AGENT_SCHEDULES" PRIMARY KEY("PROJECT_ID");
CREATE INDEX "IDX_AGENT_SCHEDULES_DUE" ON "AGENT_SCHEDULES"("NEXT_RUN_AT" NULLS FIRST);
...
ALTER TABLE "ARCH_DIRECTIVES" ADD CONSTRAINT "PK_ARCH_DIRECTIVES" PRIMARY KEY("PROJECT_ID", "UUID");
CREATE INDEX "ARCH_DIRECTIVES_UUID" ON "ARCH_DIRECTIVES"("UUID" NULLS FIRST);

CREATE TABLE "ARCH_GRAPH_BLOBS"(
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "NAME" CHARACTER VARYING(40) NOT NULL,
    "DATA" BINARY LARGE OBJECT NOT NULL,
    "METADATA" CHARACTER VARYING(4000)
);
ALTER TABLE "ARCH_GRAPH_BLOBS" ADD CONSTRAINT "PK_ARCH_GRAPH_BLOBS" PRIMARY KEY("UUID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "ARCH_GRAPH_BLOBS_NAME" ON "ARCH_GRAPH_BLOBS"("NAME" NULLS FIRST);

CREATE TABLE "ARCH_GRAPH_METADATA"(
    "ORGANIZATION_ID" CHARACTER VARYING(40) NOT NULL,
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "ANALYSIS_ID" CHARACTER VARYING(40) NOT NULL,
    "PROJECT_ID" CHARACTER VARYING(40) NOT NULL,
    "BRANCH_ID" CHARACTER VARYING(40) NOT NULL,
...
ALTER TABLE "ARCH_GRAPH_METADATA" ADD CONSTRAINT "PK_ARCH_GRAPH_METADATA" PRIMARY KEY("ORGANIZATION_ID", "UUID");
CREATE INDEX "ARCH_GRAPH_METADATA_UUID" ON "ARCH_GRAPH_METADATA"("UUID" NULLS FIRST);
CREATE INDEX "ARCH_GRAPH_METADATA_ANALYSIS" ON "ARCH_GRAPH_METADATA"("ORGANIZATION_ID" NULLS FIRST, "ANALYSIS_ID" NULLS FIRST);
CREATE INDEX "ARCH_GRAPH_METADATA_PROJECT" ON "ARCH_GRAPH_METADATA"("ORGANIZATION_ID" NULLS FIRST, "PROJECT_ID" NULLS FIRST);
CREATE INDEX "ARCH_GRAPH_METADATA_BRANCH" ON "ARCH_GRAPH_METADATA"("ORGANIZATION_ID" NULLS FIRST, "BRANCH_ID" NULLS FIRST);

CREATE TABLE "ARCH_INTENDED"(
    "PROJECT_ID" CHARACTER VARYING(40) NOT NULL,
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "ORGANIZATION_ID" CHARACTER VARYING(40) NOT NULL,
    "DATA" CHARACTER LARGE OBJECT NOT NULL
);
ALTER TABLE "ARCH_INTENDED" ADD CONSTRAINT "PK_ARCH_INTENDED" PRIMARY KEY("PROJECT_ID", "UUID");
CREATE INDEX "ARCH_INTENDED_UUID" ON "ARCH_INTENDED"("UUID" NULLS FIRST);

CREATE TABLE "ARCH_SCANNER_DATA"(
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "NAME" CHARACTER VARYING(255) NOT NULL,
    "DATA" BINARY LARGE OBJECT NOT NULL,
    "METADATA" CHARACTER VARYING(4000)
);
ALTER TABLE "ARCH_SCANNER_DATA" ADD CONSTRAINT "PK_ARCH_SCANNER_DATA" PRIMARY KEY("UUID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "ARCH_SCANNER_DATA_NAME" ON "ARCH_SCANNER_DATA"("NAME" NULLS FIRST);
...
ALTER TABLE "CE_TASK_INPUT" ADD CONSTRAINT "PK_CE_TASK_INPUT" PRIMARY KEY("TASK_UUID", "PART_NUMBER");
...
CREATE INDEX "COMPONENTS_LOWER_KEE" ON "COMPONENTS"("KEE" NULLS FIRST);
CREATE INDEX "COMPONENTS_COPY_COMPONENT" ON "COMPONENTS"("COPY_COMPONENT_UUID" NULLS FIRST);
...
CREATE TABLE "INTEGRATION_BINDINGS"(
    ...
    "ENTITY_UUID" CHARACTER VARYING(40) NOT NULL,
    "TOKEN_TYPE" CHARACTER VARYING(20) NOT NULL,
    "UPDATED_BY" CHARACTER VARYING(40) NOT NULL,
    "ACCESS_TOKEN" CHARACTER LARGE OBJECT NOT NULL,
    "REFRESH_TOKEN" CHARACTER LARGE OBJECT,
    "SCOPE" CHARACTER LARGE OBJECT,
    "EXPIRES_IN_SECONDS" BIGINT,
    "EXTRA_DETAILS" CHARACTER LARGE OBJECT
);
ALTER TABLE "INTEGRATION_BINDINGS" ADD CONSTRAINT "PK_INTEGRATION_BINDINGS" PRIMARY KEY("ID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "INTEGRATION_BINDINGS_IDX" ON "INTEGRATION_BINDINGS"("INTEGRATION_TYPE" NULLS FIRST, "ENTITY_TYPE" NULLS FIRST, "ENTITY_UUID" NULLS FIRST);
...
ALTER TABLE "INTEGRATION_CONFIGS" ADD CONSTRAINT "PK_INTEGRATION_CONFIGS" PRIMARY KEY("UUID");
...
CREATE TABLE "ISSUE_COUNT_DIMENSIONS"(
    "ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "HOTSPOT_RESOLUTION" CHARACTER VARYING(40),
    "ISSUE_CODE_SCOPE" CHARACTER VARYING(40) NOT NULL,
    "ISSUE_SEVERITY" CHARACTER VARYING(40) NOT NULL,
    "ISSUE_STATUS" CHARACTER VARYING(40),
    "STATUS" CHARACTER VARYING(40),
    "ISSUE_TYPE" SMALLINT NOT NULL,
    "RULE_KEY" CHARACTER VARYING(200) NOT NULL,
    "DIMENSION_HASH" CHARACTER VARYING(40) NOT NULL,
    "MAINTAINABILITY_RATING" SMALLINT NOT NULL,
    "SECURITY_RATING" SMALLINT NOT NULL,
    "RELIABILITY_RATING" SMALLINT NOT NULL
);
ALTER TABLE "ISSUE_COUNT_DIMENSIONS" ADD CONSTRAINT "PK_ISSUE_COUNT_DIMENSIONS" PRIMARY KEY("ID");
CREATE INDEX "ISS_CNT_DIM_RULE_KEY_IDX" ON "ISSUE_COUNT_DIMENSIONS"("RULE_KEY" NULLS FIRST);
CREATE UNIQUE NULLS NOT DISTINCT INDEX "ISS_CNT_DIM_HASH_UQ_IDX" ON "ISSUE_COUNT_DIMENSIONS"("DIMENSION_HASH" NULLS FIRST);

CREATE TABLE "ISSUE_COUNT_HISTORY"(
...
CREATE UNIQUE NULLS NOT DISTINCT INDEX "ISS_CNT_HIST_EPOCH_UQ_IDX2" ON "ISSUE_COUNT_HISTORY"("ENTITY_ID" NULLS FIRST, "ENTITY_TYPE" NULLS FIRST, "DIMENSION_ID" NULLS FIRST, "RECORDED_AT_EPOCH" DESC NULLS LAST);
CREATE INDEX "ISS_CNT_HIST_EPOCH_TIME_IDX" ON "ISSUE_COUNT_HISTORY"("ENTITY_ID" NULLS FIRST, "ENTITY_TYPE" NULLS FIRST, "RECORDED_AT_EPOCH" NULLS FIRST);

CREATE TABLE "ISSUE_STATS_BY_RULE_KEY"(
    "AGGREGATION_TYPE" CHARACTER VARYING(20) NOT NULL,
    "AGGREGATION_ID" CHARACTER VARYING(40) NOT NULL,
    "RULE_KEY" CHARACTER VARYING(456) NOT NULL,
    "ISSUE_COUNT" INTEGER NOT NULL,
    "RATING" INTEGER NOT NULL,
    "MQR_RATING" INTEGER NOT NULL,
    "HOTSPOT_COUNT" INTEGER,
    "HOTSPOTS_REVIEWED" INTEGER
);
ALTER TABLE "ISSUE_STATS_BY_RULE_KEY" ADD CONSTRAINT "PK_ISSUE_STATS_BY_RULE_KEY" PRIMARY KEY("AGGREGATION_TYPE", "AGGREGATION_ID", "RULE_KEY");
...
CREATE TABLE "JIRA_ORG_BINDINGS"(
    ...
    "JIRA_ACCESS_TOKEN" CHARACTER LARGE OBJECT,
    "JIRA_ACCESS_TOKEN_EXPIRES_AT" BIGINT,
    "JIRA_REFRESH_TOKEN" CHARACTER LARGE OBJECT,
    "JIRA_REFRESH_TOKEN_CREATED_AT" BIGINT,
    "JIRA_REFRESH_TOKEN_UPDATED_AT" BIGINT,
    "UPDATED_BY" CHARACTER VARYING(40),
    "IS_TOKEN_SHARED" BOOLEAN DEFAULT FALSE NOT NULL
);
ALTER TABLE "JIRA_ORG_BINDINGS" ADD CONSTRAINT "PK_JIRA_ORG_BINDINGS" PRIMARY KEY("ID");

CREATE TABLE "JIRA_ORG_BINDINGS_PENDING"(
    "ID" CHARACTER VARYING(40) NOT NULL,
    "CREATED_AT" BIGINT NOT NULL,
    "UPDATED_AT" BIGINT NOT NULL,
    "SONAR_ORGANIZATION_UUID" CHARACTER VARYING(40) NOT NULL,
    "JIRA_ACCESS_TOKEN" CHARACTER LARGE OBJECT NOT NULL,
    "JIRA_ACCESS_TOKEN_EXPIRES_AT" BIGINT NOT NULL,
    "JIRA_REFRESH_TOKEN" CHARACTER LARGE OBJECT NOT NULL,
    "JIRA_REFRESH_TOKEN_CREATED_AT" BIGINT NOT NULL,
    "JIRA_REFRESH_TOKEN_UPDATED_AT" BIGINT NOT NULL,
    "UPDATED_BY" CHARACTER VARYING(40) NOT NULL
);
ALTER TABLE "JIRA_ORG_BINDINGS_PENDING" ADD CONSTRAINT "PK_JIRA_ORG_BINDINGS_PENDING" PRIMARY KEY("ID");
...
CREATE UNIQUE NULLS NOT DISTINCT INDEX "IDX_JIRA_PROJ_BINDINGS_UNIQUE" ON "JIRA_PROJECT_BINDINGS"("JIRA_ORGANIZATION_BINDING_ID" NULLS FIRST, "SONAR_PROJECT_ID" NULLS FIRST);

CREATE TABLE "JIRA_SELECTED_WORK_TYPES"(
    "ID" CHARACTER VARYING(40) NOT NULL,
    "JIRA_PROJECT_BINDING_ID" CHARACTER VARYING(40) NOT NULL,
    "WORK_TYPE_ID" CHARACTER VARYING(255) NOT NULL,
    "CREATED_AT" BIGINT NOT NULL,
    "UPDATED_AT" BIGINT NOT NULL
);
ALTER TABLE "JIRA_SELECTED_WORK_TYPES" ADD CONSTRAINT "PK_JIRA_SELECTED_WORK_TYPES" PRIMARY KEY("ID");

CREATE TABLE "JIRA_WORK_ITEMS"(
    "ID" CHARACTER VARYING(40) NOT NULL,
    "CREATED_AT" BIGINT NOT NULL,
    "UPDATED_AT" BIGINT NOT NULL,
    "JIRA_ISSUE_ID" CHARACTER VARYING(400) NOT NULL,
    "JIRA_ISSUE_KEY" CHARACTER VARYING(400) NOT NULL,
    "JIRA_ISSUE_URL" CHARACTER VARYING(2048) NOT NULL,
    "JIRA_PROJECT_BINDING_ID" CHARACTER VARYING(40) NOT NULL,
    "CREATED_BY" CHARACTER VARYING(255)
);
ALTER TABLE "JIRA_WORK_ITEMS" ADD CONSTRAINT "PK_JIRA_WORK_ITEMS" PRIMARY KEY("ID");

CREATE TABLE "JIRA_WORK_ITEMS_RESOURCES"(
    "ID" CHARACTER VARYING(40) NOT NULL,
    "CREATED_AT" BIGINT NOT NULL,
    "UPDATED_AT" BIGINT NOT NULL,
    "JIRA_WORK_ITEM_ID" CHARACTER VARYING(40) NOT NULL,
    "RESOURCE_ID" CHARACTER VARYING(400) NOT NULL,
    "RESOURCE_TYPE" CHARACTER VARYING(100) NOT NULL
);
ALTER TABLE "JIRA_WORK_ITEMS_RESOURCES" ADD CONSTRAINT "PK_JIRA_WORK_ITEMS_RESOURCES" PRIMARY KEY("ID");
CREATE INDEX "IX_RESOURCE_ID_RESOURCE_TYPE" ON "JIRA_WORK_ITEMS_RESOURCES"("RESOURCE_ID" NULLS FIRST, "RESOURCE_TYPE" NULLS FIRST);
...
CREATE UNIQUE NULLS NOT DISTINCT INDEX "MSR_HIST_EPOCH_UQ_IDX2" ON "MEASURE_HISTORY"("ENTITY_ID" NULLS FIRST, "ENTITY_TYPE" NULLS FIRST, "METRIC_ID" NULLS FIRST, "RECORDED_AT_EPOCH" DESC NULLS LAST);
CREATE INDEX "MSR_HIST_ENTITY_METRIC_IDX" ON "MEASURE_HISTORY"("ENTITY_ID" NULLS FIRST, "ENTITY_TYPE" NULLS FIRST, "METRIC_ID" NULLS FIRST);

CREATE TABLE "MEASURE_KEY_MAPPING"(
...
ALTER TABLE "MEASURE_KEY_MAPPING" ADD CONSTRAINT "PK_MEASURE_KEY_MAPPING" PRIMARY KEY("ID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "MSR_KEY_MAPPING_NAME_UQ_IDX" ON "MEASURE_KEY_MAPPING"("METRIC_NAME" NULLS FIRST);
...
CREATE TABLE "SCA_ANALYSES"(
    ...
    "CREATED_AT" BIGINT NOT NULL,
    "UPDATED_AT" BIGINT NOT NULL,
    "FAILED_REASON" CHARACTER LARGE OBJECT
);
...
CREATE UNIQUE NULLS NOT DISTINCT INDEX "SCA_ENCOUNTERED_LIC_ORG_UNIQ" ON "SCA_ENCOUNTERED_LICENSES"("ORGANIZATION_UUID" NULLS FIRST, "LICENSE_POLICY_ID" NULLS FIRST);

CREATE TABLE "SCA_IR_CVE_LOCATIONS"(
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "SCA_ISSUES_RELEASES_UUID" CHARACTER VARYING(40) NOT NULL,
    "CVE_ID" CHARACTER VARYING(63) NOT NULL,
    "SIGNATURE" CHARACTER VARYING(1000) NOT NULL,
    "FILE_PATH" CHARACTER VARYING(1000) NOT NULL,
    "START_LINE" INTEGER NOT NULL,
    "START_LINE_OFFSET" INTEGER NOT NULL,
    "END_LINE" INTEGER NOT NULL,
    "END_LINE_OFFSET" INTEGER NOT NULL,
    "CREATED_AT" BIGINT NOT NULL,
    "UPDATED_AT" BIGINT NOT NULL,
    "SIGNATURE_TYPE" CHARACTER VARYING(31) NOT NULL
);
ALTER TABLE "SCA_IR_CVE_LOCATIONS" ADD CONSTRAINT "PK_SCA_IR_CVE_LOCATIONS" PRIMARY KEY("UUID");
CREATE INDEX "SCA_IR_CVE_LOC_IR_UUID" ON "SCA_IR_CVE_LOCATIONS"("SCA_ISSUES_RELEASES_UUID" NULLS FIRST);

CREATE TABLE "SCA_ISSUE_DIMENSIONS"(
    "ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "DIMENSION_HASH" CHARACTER VARYING(32) NOT NULL,
    "SEVERITY" CHARACTER VARYING(32) NOT NULL,
    "STATUS" CHARACTER VARYING(32)
);
ALTER TABLE "SCA_ISSUE_DIMENSIONS" ADD CONSTRAINT "PK_SCA_ISSUE_DIMENSIONS" PRIMARY KEY("ID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "SCA_ISSUE_DIMENSIONS_HASH" ON "SCA_ISSUE_DIMENSIONS"("DIMENSION_HASH" NULLS FIRST);
...
CREATE INDEX "SCA_ISSUES_UPDATED_AT" ON "SCA_ISSUES"("UPDATED_AT" NULLS FIRST);
...
CREATE INDEX "SCA_IR_COMPONENT_UUID" ON "SCA_ISSUES_RELEASES"("COMPONENT_UUID" NULLS FIRST);
CREATE INDEX "SCA_ISSUES_RELEASES_UPDATED_AT" ON "SCA_ISSUES_RELEASES"("UPDATED_AT" NULLS FIRST);
...
CREATE INDEX "SCA_RELEASES_UPDATED_AT" ON "SCA_RELEASES"("UPDATED_AT" NULLS FIRST);

CREATE TABLE "SCA_TTR_HISTORY"(
    "ENTITY_ID" CHARACTER VARYING(255) NOT NULL,
    "ENTITY_TYPE" CHARACTER VARYING(32) NOT NULL,
    "SCA_DIMENSION_ID" INTEGER NOT NULL,
    "RECORDED_AT_EPOCH" BIGINT NOT NULL,
    "TOTAL_MINUTES_TO_RESOLUTION" BIGINT NOT NULL,
    "SCA_ISSUES_RESOLVED" INTEGER NOT NULL
);
CREATE UNIQUE NULLS NOT DISTINCT INDEX "SCA_TTR_HISTORY_UQ_IDX" ON "SCA_TTR_HISTORY"("ENTITY_ID" NULLS FIRST, "ENTITY_TYPE" NULLS FIRST, "SCA_DIMENSION_ID" NULLS FIRST, "RECORDED_AT_EPOCH" DESC NULLS LAST);
CREATE INDEX "SCA_TTR_HISTORY_ENT_TYPE_EPOCH" ON "SCA_TTR_HISTORY"("ENTITY_ID" NULLS FIRST, "ENTITY_TYPE" NULLS FIRST, "RECORDED_AT_EPOCH" NULLS FIRST);
...
CREATE TABLE "SLACK_SUBSCRIPTIONS"(
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "USER_BINDING_UUID" CHARACTER VARYING(40) NOT NULL,
    "SLACK_WORKSPACE_UUID" CHARACTER VARYING(40) NOT NULL,
    "CHANNEL_ID" CHARACTER VARYING(255) NOT NULL,
    "RESOURCE_TYPE" CHARACTER VARYING(20) NOT NULL,
    "RESOURCE_ID" CHARACTER VARYING(40) NOT NULL,
    "CREATED_AT" BIGINT NOT NULL,
    "UPDATED_AT" BIGINT NOT NULL
);
ALTER TABLE "SLACK_SUBSCRIPTIONS" ADD CONSTRAINT "PK_SLACK_SUBSCRIPTIONS" PRIMARY KEY("UUID");
CREATE INDEX "SS_USER_BINDING_UUID" ON "SLACK_SUBSCRIPTIONS"("USER_BINDING_UUID" NULLS FIRST);
CREATE INDEX "SS_SLACK_WORKSPACE_UUID" ON "SLACK_SUBSCRIPTIONS"("SLACK_WORKSPACE_UUID" NULLS FIRST);
CREATE INDEX "SS_RESOURCE_TYPE_ID" ON "SLACK_SUBSCRIPTIONS"("RESOURCE_TYPE" NULLS FIRST, "RESOURCE_ID" NULLS FIRST);

CREATE TABLE "SLACK_WORKSPACES"(
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "INTEGRATION_CONFIG_UUID" CHARACTER VARYING(40) NOT NULL,
...
ALTER TABLE "SLACK_WORKSPACES" ADD CONSTRAINT "PK_SLACK_WORKSPACES" PRIMARY KEY("UUID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "SW_WORKSPACE_ID" ON "SLACK_WORKSPACES"("WORKSPACE_ID" NULLS FIRST);
CREATE INDEX "SW_INTEGRATION_CONFIG_UUID" ON "SLACK_WORKSPACES"("INTEGRATION_CONFIG_UUID" NULLS FIRST);
...
ALTER TABLE "USER_BINDINGS_SLACK" ADD CONSTRAINT "PK_USER_BINDINGS_SLACK" PRIMARY KEY("UUID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "UBS_BINDING_WORKSPACE_USER" ON "USER_BINDINGS_SLACK"("USER_BINDING_UUID" NULLS FIRST, "SLACK_WORKSPACE_UUID" NULLS FIRST, "SLACK_USER_ID" NULLS FIRST);
CREATE INDEX "UBS_SLACK_WORKSPACE_UUID" ON "USER_BINDINGS_SLACK"("SLACK_WORKSPACE_UUID" NULLS FIRST);
